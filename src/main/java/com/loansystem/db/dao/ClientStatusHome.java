...
public class ClientStatusHome {
    ...
    public ClientStatus findById(java.lang.String id, Session session) {
    ...
    public List findByExample(ClientStatus instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession().createCriteria("ClientStatus").add(Example.create(instance)).list();
