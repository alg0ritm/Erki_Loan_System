...
import com.loansystem.model.UserDetail;
...
/**
 * Home object for domain model class UserDetail.
 * @see .UserDetail
 * @author Hibernate Tools
 */
public class UserDetailHome {

	private static final Log log = LogFactory.getLog(UserDetailHome.class);
	...
	public void persist(UserDetail transientInstance) {
		log.debug("persisting UserDetail instance");
		try {
	...
	public UserDetail merge(UserDetail detachedInstance) {
		...
		try {
			UserDetail result = (UserDetail) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public UserDetail findById(java.lang.String id) {
		log.debug("getting UserDetail instance with id: " + id);
		try {
			UserDetail instance = (UserDetail) sessionFactory.getCurrentSession().get("UserDetail", id);
			if (instance == null) {
	...
	public List findByExample(UserDetail instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("UserDetail")
